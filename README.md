...
**Made with ❤️ for the Indian Healthcare Community**
...
2. Click "Book Appointment" to add it to the list

3. View all scheduled appointments in the list below

4. Delete appointments using the trash icon
